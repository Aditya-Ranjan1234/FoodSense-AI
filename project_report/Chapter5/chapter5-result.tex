...
\begin{tabular}{|l|c|c|}
\hline
 & \textbf{Predicted Safe} & \textbf{Predicted Elevated VOC} \\
\hline
...
The LSTM model achieved a mean absolute error of $\pm$4.00 hours and a root mean squared error of 4.11 hours on the test set. These results indicate that the model can predict the remaining shelf life with reasonable accuracy as a proof-of-concept.
