...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{FoodSense: Multimodal AI System for Early Spoilage Prediction}
\subCode{XX367P}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{Aditya Ranjan}
\stuUSNA{1RV23AI008}
\stuNameB{Gnanendra Naidu N}
\stuUSNB{1RV23AI035}
\stuNameC{Arumita Nandi}
\stuUSNC{1RV23EC023}
\stuNameD{Vinay A}
\stuUSND{1RV23EC183}
...
\guideNameA{Dr Anitha Sandeep}
\guideDesignationA{Assistant Professor}
\guideDeptA[CSE]{Department of Computer Science Engineering}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%  QRL %%%%%%%%%%%%%%%%%%%%%%%%%%
\QRurl{https://huggingface.co/spaces/Chanereach/Food_Spoilage_Detection}
...
%%%%%%%%%%%%%%%% Page Background %%%%%%%%%%%%%%%%%%%%%
%% Override the default "Draft" background from the template package.
\backgroundsetup{
	scale=1,
	angle=0,
	firstpage=true,
	...
	contents={
		\begin{tikzpicture}[remember picture, overlay]
			\node at (current page.center){\includegraphics[width=0.45\textwidth]{Figures/RV_logoVec}};
		\end{tikzpicture}
	}
}
