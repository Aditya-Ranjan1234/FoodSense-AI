...
The MQ135 is a low-cost metal-oxide gas sensor sensitive to ammonia, sulfide, benzene vapor, and other harmful gases. It operates by measuring the change in resistance of a tin dioxide (SnO\textsubscript{2}) layer when exposed to target gases. The sensor requires a load resistor (typically 10 k$\Omega$) and operates at 5V DC.
