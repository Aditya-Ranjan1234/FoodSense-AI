...
class PigmentClassifierNN(nn.Module):
    def __init__(self, input_dim=3, num_classes=3):
        """
        Input features: [Abs_430, Abs_540, Abs_660]
        Output classes: [Fresh, Ripe, Spoiled]
        """
...
class TemporalAttention(nn.Module):
    ...
    def forward(self, lstm_out):
        ...
        attn_scores = self.attn_weights(lstm_out) # [batch, seq_len, 1]
...
class SpoilageLSTM(nn.Module):
    def __init__(self, input_dim=4, hidden_dim=64, num_layers=2):
        ...
        self.fc = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(32, 1) # Outputs remaining shelf life in hours
        )
